...
<head>
    ...
    <title>Order | Flame & Fragrance</title>
        ...
        <div class="orders">
            ...
            <div class="order">
                <div class="top">
                    ...
                    <div>Total Price : {{$order->totalPrice}} MAD</div>
                ...
                @foreach($order->orderLines as $orderLine)
                    ...
                    <div class="bottom">
                        ...
                        <div class="left">
                            <form action="{{ route('order.delete', ['orderId' => $order->id]) }}" method="POST">
                                @csrf
                                @method('DELETE')
